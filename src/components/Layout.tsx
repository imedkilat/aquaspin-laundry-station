...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-svh bg-slate-100 dark:bg-slate-950">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white/95 px-2 pb-[max(env(safe-area-inset-bottom),0.35rem)] pt-1.5 backdrop-blur dark:border-slate-800 dark:bg-slate-900/95 md:hidden">
