      ...
      <header className="bg-white border-b border-slate-200 dark:bg-slate-900 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-slate-900 leading-tight dark:text-slate-100">{SHOP_NAME}</p>
          ...
          <nav className="flex items-center gap-2 flex-wrap">
            ...
            <button
              onClick={signOut}
              className="px-3 py-1.5 rounded-lg text-sm font-medium text-slate-500 hover:bg-slate-200 transition dark:text-slate-400 dark:hover:bg-slate-800"
            >
              Sign out
            </button>
          </nav>
